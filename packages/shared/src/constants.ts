export const LIMITS = {
  ...
  /** 默认播放列表的固定歌曲上限（65536 为实际不可达的防滥用上限） */
  DEFAULT_QUEUE_MAX_SIZE: 65_536,
  ...
  SEARCH_PAGE_MAX: 100,
  /** 单个外部歌单读取与全量搜索最多支持的歌曲数 */
  PLAYLIST_SEARCH_MAX_TRACKS: 10_000,
  /** 歌单内搜索固定分页大小 */
  PLAYLIST_SEARCH_PAGE_SIZE: 50,
  /** 10,000 首歌按每页 50 首时的最后一页 */
  PLAYLIST_SEARCH_PAGE_MAX: 200,
